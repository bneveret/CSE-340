...
ALTER TYPE public.account_type OWNER TO everett31945;
...
-- Assignment2 Query4 Update "GM Hummer" description to replace "small interiors" with "a huge interior"
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';
-- Assignment2 Query6 Update all inventory image paths to include "/vehicles"
UPDATE public.inventory
